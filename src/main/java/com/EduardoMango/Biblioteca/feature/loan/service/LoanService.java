...
public class LoanService {
    ...
    public LoanResponse createLoan(LoanCreateRequest request, String authenticatedPrincipalName) {
        ...
        Book book = bookRepository.findByPublicId(request.libroPublicId())
                .orElseThrow(() -> new ResourceNotFoundException("Libro no encontrado con publicId: " + request.libroPublicId()));
